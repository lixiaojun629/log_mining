...
public class JDBCTableModel extends AbstractTableModel {
	...
	public JDBCTableModel(Connection conn, String query,String tableName,String[] titles)
			throws SQLException {
		super();
		this.titles = titles;
		getTableContents(conn, query,tableName);

	}

	protected void getTableContents(Connection conn, String query,String tableName)
			throws SQLException {
		...
		while (results.next()) {
			...
			default:
				...
				System.out.println("can't assgin!");
				break;
			}
